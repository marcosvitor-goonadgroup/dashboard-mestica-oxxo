/**
 * Serviço para buscar imagens de criativos do Google Drive e assets locais
 */

// Mapeamento de assets locais: filename sem extensão -> URL do asset
...
/**
 * Busca imagem local pelo adName (comparação exata com filename sem extensão)
 */
...
export const getCreativeImageUrl = (creativeName: string): string | null => {
  // Estratégia 0: Asset local — match exato pelo adName (filename sem extensão)
